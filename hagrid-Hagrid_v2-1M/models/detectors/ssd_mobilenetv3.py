...
class SSDLiteMobilenet_large(HaGRIDModel):
    ...
    def __init__(
        ...
        # Use new torchvision API with 'weights' parameter
        weights = None  # Don't load pretrained weights
        weights_backbone = None
        
        hagrid_model = torchvision.models.detection.ssdlite320_mobilenet_v3_large(
            weights=weights, weights_backbone=weights_backbone, num_classes=num_classes
        )
...
class SSDLiteMobilenet_small(HaGRIDModel):
    ...
    def __init__(
        ...
        # Use custom ssdlite320_mobilenet_v3_small function that doesn't require deprecated params
